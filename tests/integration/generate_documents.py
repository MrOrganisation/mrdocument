...
DOCUMENTS = {
    ...
    "backfill_test_rechnung": {
        ...
        "content": [
            ...
            ("body", ""),
            ("body", "Datum: 15. Maerz 2025"),
            ("body", "Rechnungsnummer: RE-2025-03-BACKFILL"),
            ("body", ""),
            ("heading", "RECHNUNG (Kopie fuer Backfill-Test)"),
            ("body", ""),
            ("body", "Sehr geehrte Damen und Herren,"),
            ("body", ""),
            ("body", "hiermit stellen wir Ihnen folgende Leistungen in Rechnung:"),
    ...
    "sorted_wrongctx_txt": {
        ...
        "content": [
            ("heading", "Fischer AG"),
            ("subheading", "Hafenstrasse 8, 20457 Hamburg"),
            ("body", ""),
            ("body", "Datum: 15. Januar 2025"),
            ("body", ""),
            ("heading", "NACHTRAG ZUM DIENSTVERTRAG"),
            ("body", ""),
            ("body", "Zwischen Fischer AG (Arbeitgeber)"),
            ("body", "und Max Mustermann (Arbeitnehmer)"),
            ("body", ""),
            ("body", "wird folgender Nachtrag zum bestehenden Dienstvertrag vereinbart:"),
            ("body", ""),
            ("body", "1. Ab dem 01.02.2025 erhoehen sich die Bezuege um 5%."),
            ("body", "2. Die woechentliche Arbeitszeit betraegt unveraendert 40 Stunden."),
            ("body", "3. Alle uebrigen Bestimmungen des Dienstvertrages bleiben unveraendert."),
            ("body", ""),
            ("body", "Hamburg, den 15. Januar 2025"),
            ("body", ""),
            ("body", "Fischer AG"),
            ("body", "Dr. Klaus Fischer, Vorstand"),
        ],
    },
    "sorted_wrongctx_pdf": {
        "context": "privat",
        ...
        "content": [
            ...
            ("subheading", "Lindenallee 23, 50668 Koeln"),
            ("body", ""),
            ("body", "Datum: 10. Januar 2025"),
            ("body", ""),
            ("heading", "ARZTBRIEF - NACHUNTERSUCHUNG"),
            ("body", ""),
            ("body", "Patient: Max Mustermann, geb. 15.03.1985"),
            ("body", "Untersuchungsdatum: 10.01.2025"),
            ("body", ""),
            ("body", "Sehr geehrte Kolleginnen und Kollegen,"),
            ("body", ""),
            ("body", "ich berichte ueber die Nachuntersuchung des o.g. Patienten am 10.01.2025."),
            ("body", ""),
            ("body", "Verlauf:"),
            ("body", "Die Rueckenschmerzen haben sich unter Physiotherapie deutlich gebessert."),
            ("body", "Lasegue links jetzt negativ. Patient beschwerdefrei."),
            ("body", ""),
            ("body", "Diagnose:"),
            ("body", "Lumboischialgiesyndrom links, in Remission."),
            ("body", ""),
            ("body", "Empfehlung:"),
            ("body", "Physiotherapie kann beendet werden. Kontrolltermin in 3 Monaten."),
            ("body", ""),
            ("body", "Mit kollegialen Gruessen"),
            ("body", "Dr. med. Heinrich Braun"),
        ],
